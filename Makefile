...
coverage: ## check code coverage quickly with the default Python
	coverage run --source chibi_command setup.py test
	coverage report -m
	coverage html
	$(BROWSER) coverage_html_report/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/chibi_command.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ chibi_command
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
release: dist check_dist ## package and upload a release
	twine upload dist/*
